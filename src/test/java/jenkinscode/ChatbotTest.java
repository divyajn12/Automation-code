...
public class ChatbotTest {
    ...
    public void testChatbotResponses() {
        ...
        try (FileWriter writer = new FileWriter("chatbot_responses.csv")) {
            // Write CSV headers
            ...
            String[] questions = {
                ...
                "filter my points by created date?","view only redeemed points?","check all my available coupons?","coupon code is QEWR1ABUB find campaign name?",
                "share the validity of coupon code?","maximum discount of this QEWR1ABUB coupon?","list ofexpired coupons?","share the higest discount applied in coupon",
